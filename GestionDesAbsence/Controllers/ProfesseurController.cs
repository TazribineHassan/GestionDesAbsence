    ...
    public class ProfesseurController : Controller
    {
        ...
        public string testData()
        {
            using (GestionDesAbsenceContext db = new GestionDesAbsenceContext())
            {
                ...
                //    if(i < 50)
                //    {
                //        etudiants.Add(new Etudiant() { Id = 0, Cne = "D132468" + i, Nom = "TAZRIBINE" + i + "", Prenom = "Hassan" + i + "", Email = "hassan" + i + "@gmail.com", Password = Encryption.Encrypt("etudiant"), Id_groupe = 1, Role_Id = 3 });
                //    }
                //    else
                //    {
                //        etudiants.Add(new Etudiant() { Id = 0, Cne = "D132468" + i, Nom = "TAZRIBINE" + i + "", Prenom = "Hassan" + i + "", Email = "hassan" + i + "@gmail.com", Password = Encryption.Encrypt("etudiant"), Id_groupe = 2, Role_Id = 3 });
                //    }
                ...
                //semaines.Add(new Semaine() { id = 0, Code = "S1", Date_debut = DateTime.Parse("08/05/2021"), Date_fin = DateTime.Parse("05/14/2021") });
