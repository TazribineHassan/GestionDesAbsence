namespace GestionDesAbsence.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GestionDesAbsence.Models.GestionDesAbsenceContext>
    {
        ...
        protected override void Seed(GestionDesAbsence.Models.GestionDesAbsenceContext context)
        {
            ...
            //groupes.Add(new Groupe() { Id = 0, Nom = "Groupe 1", id_classe = 3 });
            //groupes.Add(new Groupe() { Id = 0, Nom = "Groupe 2", id_classe = 3 });
            //groupes.Add(new Groupe() { Id = 0, Nom = "Groupe 3", id_classe = 3 });
            //context.Classes.AddRange(classes);
            ...
            //professeurs.Add(new Professeur() { Id = 0, Code_prof = "UYGGHJ09UU9007", Nom = "OUARRACHI", Prenom = "Maryem", Email = "maryem@gmail.com", Password = Encryption.Encrypt("professeur") });
            //professeurs.Add(new Professeur() { Id = 0, Code_prof = "UYGGHJ09UU9007", Nom = "PROF 1", Prenom = "prof", Email = "prof@gmail.com", Password = Encryption.Encrypt("professeur") });
            //professeurs.Add(new Professeur() { Id = 0, Code_prof = "UYGGHJ09UU9007", Nom = "PROF 2", Prenom = "prof", Email = "prof@gmail.com", Password = Encryption.Encrypt("professeur") });
